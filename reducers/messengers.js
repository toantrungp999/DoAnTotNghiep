...
function formatContentMessage(type, content) {
  ...
  switch (type) {
    ...
    case CHAT_BOT_TYPES.ASK_HOW_TO_BUY:
      msg =
        'Để đặt hàng quý khách cần (cập nhật đủ thông tin cá nhân nếu chưa cập nhật. Sau đó truy cập vào sản phẩm và nhấn mua hàng. Nếu muốn mua sản phẩm đã có sản phẩm trong và nhấn mua hàng';
      break;
    default:
      msg = content;
      break;
